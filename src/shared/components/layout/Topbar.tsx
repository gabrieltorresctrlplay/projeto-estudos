...
import { COMPANY, NAV_LINKS } from '@/shared/constants'
...
export function Topbar() {
  ...
  return (
    <header className="bg-background/80 border-border/50 sticky top-0 z-50 w-full border-b backdrop-blur-xl transition-all duration-300">
      <nav
