...
export function Topbar() {
  ...
  return (
    <header className="bg-background/80 sticky top-0 z-50 w-full border-b border-white/5 backdrop-blur-xl transition-all duration-300">
      <nav
      ...
      >
        <Link
          to="/"
          className="group flex items-center gap-2.5 text-xl font-bold tracking-tighter transition-all hover:opacity-80"
          aria-label={`${COMPANY.name} - Página inicial`}
        >
          <div
            className="from-primary/20 to-primary/10 text-primary shadow-primary/20 flex size-9 items-center justify-center rounded-xl bg-linear-to-br shadow-inner ring-1 ring-white/10 transition-transform duration-300 group-hover:scale-110 group-active:scale-95"
            aria-hidden="true"
          >
            <svg
              className="size-5"
              viewBox="0 0 122.88 102.6"
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            className="bg-border/20 hidden h-6 w-px md:block"
            aria-hidden="true"
          />
          ...
          {loading ? (
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="hover:ring-primary/20 relative h-8 w-8 rounded-full ring-2 ring-transparent transition-all"
                >
            ...
            <Button
              ...
              asChild
              className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-primary/20 shadow-lg transition-all active:scale-95"
            >
