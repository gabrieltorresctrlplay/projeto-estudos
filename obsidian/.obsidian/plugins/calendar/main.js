...
function appHasPeriodicNotesPluginLoaded() {
  ...
  return (
    periodicNotes &&
    ((_b = (_a = periodicNotes.settings) === null || _a === void 0 ? void 0 : _a.weekly) === null ||
    _b === void 0
      ? void 0
      : _b.enabled)
  )
...
class CalendarSettingsTab extends obsidian.PluginSettingTab {
  ...
  addLocaleOverrideSetting() {
    ...
    const { moment } = window
    const sysLocale =
      (_a = navigator.language) === null || _a === void 0 ? void 0 : _a.toLowerCase()
    new obsidian.Setting(this.containerEl)
  ...
  return {
    c() {
      ...
      attr(
        ...
        'class',
        (svg_class_value =
          '' + (null_to_empty(`dot filled ${/*className*/ ctx[0]}`) + ' svelte-1widvzq')),
      )
      attr(svg, 'viewBox', '0 0 6 6')
      attr(svg, 'xmlns', 'http://www.w3.org/2000/svg')
      toggle_class(svg, 'active', /*isActive*/ ctx[2])
...
function getNoteTags(note) {
  ...
  const frontmatter =
    (_a = metadataCache.getFileCache(note)) === null || _a === void 0 ? void 0 : _a.frontmatter
  const tags = []
  if (frontmatter) {
